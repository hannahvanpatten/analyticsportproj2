...
# ---------------Results-----------------
print("**********************************************************")
print("---------------Naive Fixed Training Results---------------")
print(results_naive.head(20))
print("-----------------MAPE by Forecast Horizon-----------------")
print(horizon_metrics_naive)
print("---------------------MAPE by Product----------------------")
print(product_metrics_naive)
print("-----------------------Overall MAPE-----------------------")
print(f"{overall_mape_naive:.2f}%")
print("**********************************************************")
print("")
print("")
print("**********************************************************")
print("--------------Seasonal Fixed Training Results-------------")
print(results_seasonal.head(20))
print("-----------------MAPE by Forecast Horizon-----------------")
print(horizon_metrics_seasonal)
print("---------------------MAPE by Product----------------------")
print(product_metrics_seasonal)
print("-----------------------Overall MAPE-----------------------")
print(f"{overall_mape_seasonal:.2f}%")
print("**********************************************************")
print("")
print("")
print("**********************************************************")
print("-----------Moving Average Fixed Training Results----------")
print(results_moving_average.head(20))
print("---------MAPE for horizon-months-ahead forecasts----------")
print(horizon_metrics_moving_average)
print("-----------------MAPE by Forecast Horizon-----------------")
print(horizon_metrics_moving_average)
print("---------------------MAPE by Product----------------------")
print(product_metrics_moving_average)
print("-----------------------Overall MAPE-----------------------")
print(f"{overall_mape_moving_average:.2f}%")
print("**********************************************************")
print("")
print("")
print("**********************************************************")
print("------------Internal Evaluation - 2024 Results------------")
print(results_naive_internal_val.head(20))
print("---------MAPE for horizon-months-ahead forecasts----------")
print(horizon_metrics_naive_internal_val)
print("-----------------MAPE by Forecast Horizon-----------------")
print(horizon_metrics_naive_internal_val)
print("---------------------MAPE by Product----------------------")
print(product_metrics_naive_internal_val)
print("-----------------------Overall MAPE-----------------------")
print(f"{overall_mape_naive_internal_val:.2f}%")
print("**********************************************************")